...
//	public static  ? significantMotion ?
	...
	public static Quaternion rotationQuaternion	{ get { return rotation; } } 
	public static Quaternion rotation {
        get {
            if (Sensor.Get(Sensor.Type.GameRotationVector).available)
                return Singleton.QuaternionFromRotationVector(gameRotationVector);
            else               
                return Singleton.QuaternionFromRotationVector(rotationVector);
        }
    } 
