...
5.3p1
* hotfix to include GameRotationVector as default on some devices. This fixes issues with the Moto G4 Plus (has only GameRotationVector, no RotationVector)

5.3
* updated to support Unity 5.3
* fixed a bug in the JAR plugin causing the statistics scene to crash sometimes
* updated compile directives to support newer (and future, since Unity now allows that) iOS devices (iPhone/iPad)
...
===========
	...
	- Samsung Galaxy S6			- Android 5.0, 6.0
	- Moto G4 Plus				- Android 6.0
	- Nexus 5					- Android 4.1, 4.2, 4.3, 4.4, 5.0, 6.0
